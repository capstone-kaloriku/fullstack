...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    label: "Cocok untuk Berbagi Target",
  },
];
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-2 p-3 max-w-6xl w-full mx-auto select-none relative"
      ...
      <style>
        {`
          .bento-section {
            ...
            --primary-glow-border: rgba(${glowColor}, 0.8);
          }
