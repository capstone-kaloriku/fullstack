...
export function DataTable() {
  ...
  const [pendingDeleteLog, setPendingDeleteLog] = useState<FlatLogRow | null>(
    null,
  );
  ...
  function handleDeleteClick(log: FlatLogRow) {
  ...
  function confirmDelete() {
    ...
    startTransition(async () => {
      ...
      if (!result.success) {
        console.error(result.error || "Gagal menghapus.");
      }
      setDeletingId(null);
    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Select
            value={
              (table.getColumn("mealType")?.getFilterValue() as string) || "all"
            }
            onValueChange={(value) =>
              table
                .getColumn("mealType")
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Hapus Catatan Makanan</AlertDialogTitle>
            <AlertDialogDescription>
              Apakah kamu yakin ingin menghapus{" "}
              <strong className="text-foreground">
                {pendingDeleteLog?.nama}
              </strong>
              ? Tindakan ini tidak dapat dibatalkan dan data konsumsi akan
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={isPending && deletingId === pendingDeleteLog?.id}
            >
              {isPending && deletingId === pendingDeleteLog?.id ? (
                <>
                  <IconLoader
