...
export async function deleteAccount(userId: string) {
  ...
  if (healthError) {
    return {
      success: false,
      error: "Gagal menghapus profil kesehatan: " + healthError.message,
    };
  }
  ...
  if (logsError) {
    return {
      success: false,
      error: "Gagal menghapus log konsumsi: " + logsError.message,
    };
  }
  ...
  if (userError) {
    return {
      success: false,
      error: "Gagal menghapus akun: " + userError.message,
    };
  }
